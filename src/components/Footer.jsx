          ...
          <div id="right" className='flex flex-col-reverse   lg:flex-row gap-10  lg:gap-15 w-full lg:w-1/2'>
            <div id='pt1' className='flex pb-2  pt-2  lg:border-none justify-between  text-center lg:text-left lg:w-1/2 gap-5 lg:gap-10'>
              <div id="social" className='w-1/2 flex flex-col'>
                <h1 className='font-medium text-zinc-400 text-[6vw] lg:text-xl mb-5'>Socials</h1>
                {["Instagram", "Twitter", "LinkedIn","Facebook"].map((elem) => (<a className='mt-2 ' href=''>{elem}</a>))}
              </div>
              <div id="Sitemap" className='w-1/2  border-l-2 lg:border-none  flex flex-col'>
                <h1 className='font-medium text-zinc-400 text-[6vw] lg:text-xl mb-5'>Sitemap</h1>
                {["Home", "Work", "Careers", "Contact"].map((elem) => (<a className='mt-2' href=''>{elem}</a>))}
              </div>
            </div>
            <div id="pt2" className='text-center  lg:text-sm lg:mt-5 lg:text-right w-full lg:w-1/2 flex flex-col justify-between items-center   lg:items-end'>
